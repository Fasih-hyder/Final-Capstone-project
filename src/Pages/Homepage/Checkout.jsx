            ...
            <div class="col-xl-12 col-lg-12 col-12">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                  <li
                    class="breadcrumb-item font--medium active text-black"
                    aria-current="page"
                  >
                    Home
                  </li>
                  ...
                  <li
                    class="breadcrumb-item font--medium active text-primary"
                    aria-current="page"
                  >
                    Checkout
                  </li>
          ...
          <div class="col-xl-6 col-lg-6 bg-light rounded-3">
            <div class="gray-simple rounded-2 py-3 px-3">
              ...
              <h3 class="d-flex align-items-center fs-6 lh-base font--bold">
                <span class="square--20 font--medium circle  text-black me-2">
                  1
                </span>
                Shipping Details
              </h3>
              ...
              <div class="form-check bg-white rounded-2 p-3 ps-4 mb-4">
                ...
                >
                  <span>
                    <span class="d-block font--medium mb-1">Local Pickup</span>
                    <span class="text-body">
              ...
              <div class=" d-lg-block pt-5 mt-n3">
                <div class="form-check">
                  ...
                  <label class="form-check-label text-dark fw-medium ms-1">
                    ...
                    order, to support your experience on this site and for other
            ...
            <div class="exploi py-3 py-md-3">
              <div class="d-flex w-100 justify-content-between align-items-center border-bottom pb-2 pb-sm-2 mb-3">
                <h2 class="offcanvas-title d-flex align-items-center mb-1">
                  Your Order{" "}
                  <span class="fs-6 fw-normal text-muted ms-3">(3 items)</span>
                </h2>
              </div>
                  ...
                  <div class="d-flex mb-3">
                    <div class="me-3">
                      ...
                      <div class="d-flex flex-wrap">
                        ...
                        <div class="text-muted fs-sm me-3">
                          Weight: <span class="text-dark fw-medium">150g</span>
                        </div>
                      </div>
                    </div>
              ...
              <div class="d-sm-flex align-items-center pb-4">
                ...
                <div class="w-100 pt-1 ps-sm-4">
                  <div class="d-flex mb-3">
                    <div class="me-3">
                      <h3 class="fs-5 mb-2">
                        <span className="text-seacondry">High Headphones</span>
                      </h3>
                      <div class="d-flex flex-wrap">
                        <div class="text-muted fs-sm me-3">
                          Color: <span class="text-dark fw-medium">Red</span>
